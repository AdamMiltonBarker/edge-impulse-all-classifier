...
# Edge Impulse Acute Lymphoblastic Leukaemia Classifier
![Edge Impulse Acute Lymphoblastic Leukaemia Classifier](assets/images/edge-impulse-all-classifier.jpg "Edge Impulse Acute Lymphoblastic Leukaemia Classifier")
...
For this project we are going to use the [Acute Lymphoblastic Leukemia (ALL) image dataset](https://www.kaggle.com/datasets/mehradaria/leukemia). Acute Lymphoblastic Leukaemia can be either T lineage, or B lineage. This datset includes 4 classes: Benign, Early Pre-B, Pre-B, and Pro-B Acute Lymphoblastic Leukaemia.
...
![Upload data](assets/images/5-upload-data.jpg "Upload data")
...
![Uploading data](assets/images/6-data-uploading.jpg "Uploading data")
...
![Uploaded data](assets/images/7-data-uploaded.jpg "Uploaded data")
...
![Created Impulse](assets/images/8-create-impulse.jpg "Created Impulse")
...
![Parameters](assets/images/9-parameters.jpg "Parameters")
...
![Generate Features](assets/images/10-features.jpg "Generate Features")
...
![Architecture](assets/images/11-architecture.jpg "Architecture")
...
![Training](assets/images/12-trained.jpg "Training")
...
![Test model results](assets/images/13-platform-testing.jpg "Test model results")
...
Now we are ready to deploy our model on our NVIDIA Jetson Nano. To do this we are going to use the [Edge Impulse Linix SDK](https://github.com/edgeimpulse/linux-sdk-python/)
